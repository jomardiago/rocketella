...
export default function WhatWeOfferSection() {
  return (
    <section className="">
      ...
      />
      <div className="p-6 h-full text-lg">
        <div className="flex flex-col justify-between items-center h-full">
          <div className="flex-1 flex flex-col gap-4 text-center">
            ...
            <div>
              ...
              <button className="bg-neutral-500 text-white rounded-md w-[200px] font-normal text-base py-2 px-4 lg:py-3 lg:px-6">Learn More</button>
            </div>
          ...
          <div className="flex-1 flex justify-end mt-4">
            <div className="flex flex-col gap-4 text-center">
              <div>
                ...
                <button className="bg-neutral-500 text-white rounded-md w-[200px] py-2 px-4 lg:py-3 lg:px-6">Learn More</button>
              </div>
              <div>
