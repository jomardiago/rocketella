...
export default function FooterSection() {
  return (
    <footer className="contained py-6 text-base lg:py-10">
      <div className="flex flex-col gap-4 md:items-center">
        <Image src="/Icon-Logo-Black.png" alt="Rocketella icon" width={200} height={200} quality={100} />
        <h2 className="text-2xl font-semibold lg:text-3xl">We are Rocketella Studios</h2>
      </div>
      <div className="flex flex-col gap-4 justify-between md:flex-row md:mt-6 lg:mt-8">
        <div>
